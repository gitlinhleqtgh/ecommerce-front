...
const AddProduct = () => {
    ...
    const newPostForm = () => (
        <form className="mb-3" onSubmit={clickSubmit}>
            ...
            <button className="btn btn-outline-primary">Thêm đèn mới </button>
        </form>
    );
    ...
    return (
        <Layout title="Trang quản lý"
            description={`Xin chào ${user.name} ! Thêm đèn mới.`}
